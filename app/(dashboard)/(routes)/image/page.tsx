...
const ImagePage = ()=>{
    ...
    return (
        <div>
            <Heading title="Image Generation" description="Give shape to your ideas"
            ...
            <div className="px-4 lg:px-8">
                        ...
                        md:px-6 focus-within:shadow-sm grid grid-cols-12 gap-2">
                            ...
                            <FormItem className="col-span-12 lg:col-span-6">
                                <FormControl className="m-0 p-0">
                                    ...
                                    placeholder="Picture of a horse running in mars"
                                    {...field}
                                    />
                                </FormControl>
                            </FormItem>)} /> 
                ...
                <div className="space-y-4 mt-4">
                    ...
                    {images.length===0 && !isLoading && (
                        <Empty label="No images to generate!"/>
                    )}
                        ...
                        {images?.map((src)=>{
                            ...
                            <Card key={src} className="rounded-lg overflow-hidden">
                                <div className="aspect-square relative">
                                    <Image fill alt='Image' src={src} style={{"objectFit":"cover"}}/>
                                </div>
